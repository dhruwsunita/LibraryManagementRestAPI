package com.glearning.Library.security;
...
import com.glearning.Library.service.UserDetailsServiceImple;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/books/showFormForUpdate","/books/delete").hasAnyAuthority("ADMIN").anyRequest()
		.authenticated().and()
